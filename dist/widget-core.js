        ...
        if (typeof obj === 'object') {
          ...
          for (var key in obj) {
            if (obj.hasOwnProperty(key)) {
              var value = obj[key];
              // Convert text-related properties to strings
              if ((key === 'text' || key === 'title' || key === 'value' || key === 'altText' || 
                   key === 'placeholder' || key === 'label' || key === 'errorMessage' ||
                   key === 'fallbackText' || key === 'speak') && 
                  value !== null && value !== undefined && typeof value !== 'string' && typeof value !== 'object') {
