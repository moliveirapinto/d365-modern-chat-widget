...
(function() {
  ...
  function injectStyles(c, fontFamily, gradient) {
    ...
    css.textContent = [
      ...
      '.d365-messages{display:none;flex-direction:column;flex:1;overflow-y:auto;padding:16px;gap:12px;background:'+(c.backgroundImageUrl ? 'url('+c.backgroundImageUrl+') center/cover no-repeat, ' : '')+c.chatBgColor+';scroll-behavior:smooth}',
